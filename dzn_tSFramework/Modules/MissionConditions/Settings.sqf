...
MissionCondition1 = [ "WIN_ALL", { Hostage inArea baseTrg && {call fnc_CheckPlayersReturned} }, "Заложник спасен" ];
MissionCondition2 = [ "END_NEUTRAL", { call fnc_CheckPlayersReturned }, "Вернулись на базу/Отступили, заложник не убит" , 60 ];
MissionCondition3 = [ "WIN_DEAD", { !alive Hostage && {call fnc_CheckPlayersReturned} }, "Заложник убит, отступили", 30 ];
